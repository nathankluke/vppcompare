...
// This runs client-side so there's no API call needed.
// The first 3 digits of a US zip code reliably identify the state.
//
// How it works:
//   1. User types a 5-digit zip code (e.g., "80202")
//   2. We take the first 3 digits ("802")
//   3. Look it up in the map below → "CO" (Colorado)
//   4. Use the state code to filter VPPs by states_available
// =============================================================================

// 3-digit zip prefix → 2-letter state code
const ZIP_PREFIX_TO_STATE: Record<string, string> = {
  ...
  '144': 'NY', '145': 'NY', '146': 'NY', '147': 'NY', '148': 'NY', '149': 'NY',
  ...
  // Texas (TX)
  '733': 'TX', '750': 'TX', '751': 'TX', '752': 'TX', '753': 'TX',
  '754': 'TX', '755': 'TX', '756': 'TX', '757': 'TX', '758': 'TX',
  '759': 'TX', '760': 'TX', '761': 'TX', '762': 'TX', '763': 'TX',
  '764': 'TX', '765': 'TX', '766': 'TX', '767': 'TX', '768': 'TX',
  '769': 'TX', '770': 'TX', '771': 'TX', '772': 'TX', '773': 'TX',
...
/**
 * Convert a 5-digit zip code to a 2-letter state abbreviation.
 * Returns empty string if the zip code isn't recognized.
 */
 ...
 * Returns the code itself if not found (as a fallback).
 */
