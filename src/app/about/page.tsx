      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-slate-500">
            Australia&apos;s independent Virtual Power Plant comparison tool.
          </p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-md border border-slate-200 p-8 space-y-6 text-slate-600 leading-relaxed">
          ...
          <section>
            ...
            <p>
              VPPCompare is a free comparison website that helps Australian
              homeowners find the best Virtual Power Plant (VPP) program for
              their home. We gather information about VPP programs from across
              Australia and present it in a clear, easy-to-compare format.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Our mission is to accelerate Australia&apos;s clean energy
          ...
          <section>
            ...
            <p>
              Virtual Power Plants are transforming Australia&apos;s energy
